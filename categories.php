...
?>
 <form method = "post" action = "editcategory.php">
    ...
    <br>
            ...
            <label for="useraddexpensecategory"> Category to add: </label>
            <input type = "text" id="useraddexpensecategory" name="useraddexpensecategory" required value=""/><br>
            <br/>
  ...
  <form method = "post" action = "editcategory.php">
    <table>
    <br>
            <h2>Remove an expense category:</h2>
            <label for="userdeleteexpensecategory"> Category to remove: </label>
            <input type = "text" id="userdeleteexpensecategory" name="userdeleteexpensecategory" required value=""/><br>
            <br/>
            <input type="submit" value = "Submit">
            <br><br>
            <hr class="new1"> 
  ...
  <form method = "post" action = "editcategory.php">
    <table>
    <br>
            <h2>Add an income category:</h2>
            <label for="useraddincomecategory"> Category to add: </label>
            <input type = "text" id="useraddincomecategory" name="useraddincomecategory" required value=""/><br>
            <br/>
            <input type="submit" value = "Submit">
            <br><br>
    </table>
  ...
  <form method = "post" action = "editcategory.php">
    <table>
    <br>
            <h2>Remove an income category:</h2>
            <label for="userdeleteincomecategory"> Category to remove: </label>
            <input type = "text" id="userdeleteincomecategory" name="userdeleteincomecategory" required value=""/><br>
            <br/>
            <input type="submit" value = "Submit">
            <br><br>
            <hr class="new1"> 
