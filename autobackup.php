 ...
 * @version 1.0
 * source: https://github.com/daniloaz/myphp-backup/blob/master/myphp-backup.php
 */
/**
...
define("BACKUP_DIR", 'database_backups'); // Comment this line to use same script's directory ('.')
